                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input name="iddetalle_tarjeta" id="iddetalle_tarjeta">
                            <select id="idtarjeta" name="idtarjeta" class="form-control selectpicker" data-live-search="true" required></select>
                          </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/tb_tarjetadet.js"></script>
<?php 
}
ob_end_flush();
?>
